...
export const blogPosts: BlogPost[] = [
  {
    slug: "top-10-craziest-unboxings",
    title: "Top 10 Craziest Unboxings This Month",
...
*Try it yourself — [open a virtual box for free](/virtual) or [buy the real thing](/boxes)!*`,
  ...
  {
    slug: "meet-the-mysteryx-community",
    title: "Meet the MYSTERYX Community — 10,000 Strong",
...
- **10,000+** active users
- **50,000+** boxes opened
- **₹2 Crore+** in total rewards distributed
- **500+** boxes opened daily

### Community Highlights
Our community wall is one of the most active features on the platform. Users share their wins, suggest new items, and hype each other up.

### Top Community Moments
1. When someone pulled a MacBook and the entire comment wall exploded with 🔥 emojis
2. The great "Add PS5 to the loot pool" petition (we're working on it!)
...
*Be part of the fam — [join now](/boxes)!*`,
    author: "MYSTERYX Team",
    date: "2026-04-10",
    category: "community",
    readTime: 3,
...
*Ready to apply these tips? [Head to the boxes](/boxes)!*`,
  ...
  {
    slug: "story-behind-mysteryx",
    title: "The Story Behind MYSTERYX",
    excerpt: "How a crazy idea about mystery boxes turned into India's most exciting unboxing platform.",
    content: `## From Idea to Obsession

MYSTERYX started with a simple question: "What if opening a package could be the most exciting part of your day?"
